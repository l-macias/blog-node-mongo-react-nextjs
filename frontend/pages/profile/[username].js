  ...
  const head = () => {
    return (
      <Head>
        ...
        <meta name="description" content={`Posts de ${user.username}`} />
        <link rel="canonical" href={`${DOMAIN}/profile/${query.username}`} />
        <meta property="og:title" content={` ${user.username} |${APP_NAME}`} />
        <meta property="og:description" content={`Posts de ${user.username}`} />
        ...
        <meta property="og:image" content={`${DOMAIN}/static/images/img.jpg`} />
        <meta
              ...
              <div className="card">
                <div className="card-body">
                  ...
                  <p className="text-muted">
                    Se ha unido {moment(user.createdAt).fromNow()}
                  </p>
                </div>
              </div>
            </div>
